...
@JsonPropertyOrder({
  ...
  PartitionBean.JSON_PROPERTY_FEDERATED_TYPE_C_R,
  PartitionBean.JSON_PROPERTY_FEDERATED_TYPE_A_V,
...
public class PartitionBean {
  ...
  public static final String JSON_PROPERTY_FEDERATED_TYPE_C_R = "federatedTypeCR";
  @jakarta.annotation.Nullable
  private Boolean federatedTypeCR;

  public static final String JSON_PROPERTY_FEDERATED_TYPE_A_V = "federatedTypeAV";
  @jakarta.annotation.Nullable
  private Boolean federatedTypeAV;
  ...
  public PartitionBean federatedTypeCR(@jakarta.annotation.Nullable Boolean federatedTypeCR) {
  ...
  /**
   * Get federatedTypeCR
   * @return federatedTypeCR
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_FEDERATED_TYPE_C_R)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public Boolean getFederatedTypeCR() {
    return federatedTypeCR;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FEDERATED_TYPE_C_R)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFederatedTypeCR(@jakarta.annotation.Nullable Boolean federatedTypeCR) {
    this.federatedTypeCR = federatedTypeCR;
  }


  public PartitionBean federatedTypeAV(@jakarta.annotation.Nullable Boolean federatedTypeAV) {
  ...
  /**
   * Get federatedTypeAV
   * @return federatedTypeAV
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_FEDERATED_TYPE_A_V)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public Boolean getFederatedTypeAV() {
    return federatedTypeAV;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FEDERATED_TYPE_A_V)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFederatedTypeAV(@jakarta.annotation.Nullable Boolean federatedTypeAV) {
    this.federatedTypeAV = federatedTypeAV;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, partitionBean.id) &&
        ...
        Objects.equals(this.federatedTypeCR, partitionBean.federatedTypeCR) &&
        Objects.equals(this.federatedTypeAV, partitionBean.federatedTypeAV) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, updatable, isNew, locked, federatedTypeCR, federatedTypeAV, sourceInfo, targetInfo, areas, mappings, errorMessage, links);
  }
  ...
  public String toString() {
    ...
    sb.append("    federatedTypeCR: ").append(toIndentedString(federatedTypeCR)).append("\n");
    sb.append("    federatedTypeAV: ").append(toIndentedString(federatedTypeAV)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `federatedTypeCR` to the URL query string
    if (getFederatedTypeCR() != null) {
      joiner.add(String.format("%sfederatedTypeCR%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getFederatedTypeCR()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `federatedTypeAV` to the URL query string
    if (getFederatedTypeAV() != null) {
      joiner.add(String.format("%sfederatedTypeAV%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getFederatedTypeAV()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
