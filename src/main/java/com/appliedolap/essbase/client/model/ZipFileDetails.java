 ...
 */
@JsonPropertyOrder({
  ZipFileDetails.JSON_PROPERTY_PATH
})
...
public class ZipFileDetails {
  ...
  public ZipFileDetails() { 
  }

  public ZipFileDetails path(@jakarta.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  /**
   * Return true if this ZipFileDetails object is equal to o.
   */
  @Override
