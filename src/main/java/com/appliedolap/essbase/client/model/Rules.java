...
import com.appliedolap.essbase.client.model.DataSourceDefinition;
...
public class Rules {
  ...
  public Rules dataSource(@jakarta.annotation.Nullable DataSourceDefinition dataSource) {
  ...
  @JsonProperty(JSON_PROPERTY_DATA_SOURCE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDataSource(@jakarta.annotation.Nullable DataSourceDefinition dataSource) {
    this.dataSource = dataSource;
  }
