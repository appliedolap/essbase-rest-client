 ...
 */
@JsonPropertyOrder({
  ApproverListResponse.JSON_PROPERTY_ITEMS,
  ApproverListResponse.JSON_PROPERTY_COUNT,
  ApproverListResponse.JSON_PROPERTY_TOTAL_RESULTS,
  ApproverListResponse.JSON_PROPERTY_HAS_MORE,
  ApproverListResponse.JSON_PROPERTY_LIMIT,
  ApproverListResponse.JSON_PROPERTY_PROPERTIES,
  ApproverListResponse.JSON_PROPERTY_OFFSET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class ApproverListResponse {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @jakarta.annotation.Nullable
  private List<ApproverBean> items = new ArrayList<>();
  ...
  public ApproverListResponse items(@jakarta.annotation.Nullable List<ApproverBean> items) {
    this.items = items;
    return this;
  }

  public ApproverListResponse addItemsItem(ApproverBean itemsItem) {
    if (this.items == null) {
  ...
  public List<ApproverBean> getItems() {
    return items;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<ApproverBean> items) {
    this.items = items;
  }


  public ApproverListResponse count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public ApproverListResponse totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public ApproverListResponse hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public ApproverListResponse limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ApproverListResponse properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public ApproverListResponse putPropertiesItem(String key, String propertiesItem) {
  ...
  public ApproverListResponse offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  /**
   * Return true if this ApproverListResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ApproverListResponse approverListResponse = (ApproverListResponse) o;
    return Objects.equals(this.items, approverListResponse.items) &&
        Objects.equals(this.count, approverListResponse.count) &&
        Objects.equals(this.totalResults, approverListResponse.totalResults) &&
        Objects.equals(this.hasMore, approverListResponse.hasMore) &&
        Objects.equals(this.limit, approverListResponse.limit) &&
        Objects.equals(this.properties, approverListResponse.properties) &&
        Objects.equals(this.offset, approverListResponse.offset);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApproverListResponse {\n");
