...
import com.appliedolap.essbase.client.model.DatabaseSizeStatistics;
 ...
 */
@JsonPropertyOrder({
  DBSizeList.JSON_PROPERTY_ITEMS,
  DBSizeList.JSON_PROPERTY_TOTAL_RESULTS,
  DBSizeList.JSON_PROPERTY_LIMIT,
  DBSizeList.JSON_PROPERTY_OFFSET,
  DBSizeList.JSON_PROPERTY_COUNT,
  DBSizeList.JSON_PROPERTY_HAS_MORE,
  DBSizeList.JSON_PROPERTY_PROPERTIES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class DBSizeList {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @jakarta.annotation.Nullable
  private List<DatabaseSizeStatistics> items = new ArrayList<>();
  ...
  public DBSizeList items(@jakarta.annotation.Nullable List<DatabaseSizeStatistics> items) {
    this.items = items;
    return this;
  }

  public DBSizeList addItemsItem(DatabaseSizeStatistics itemsItem) {
    if (this.items == null) {
  ...
  public List<DatabaseSizeStatistics> getItems() {
    return items;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<DatabaseSizeStatistics> items) {
    this.items = items;
  }


  public DBSizeList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public DBSizeList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public DBSizeList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  public DBSizeList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public DBSizeList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public DBSizeList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public DBSizeList putPropertiesItem(String key, String propertiesItem) {
  ...
  /**
   * Return true if this DBSizeList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DBSizeList dbSizeList = (DBSizeList) o;
    return Objects.equals(this.items, dbSizeList.items) &&
        Objects.equals(this.totalResults, dbSizeList.totalResults) &&
        Objects.equals(this.limit, dbSizeList.limit) &&
        Objects.equals(this.offset, dbSizeList.offset) &&
        Objects.equals(this.count, dbSizeList.count) &&
        Objects.equals(this.hasMore, dbSizeList.hasMore) &&
        Objects.equals(this.properties, dbSizeList.properties);
  }
