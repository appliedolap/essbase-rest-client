...
@JsonPropertyOrder({
  ...
  NamedQueriesPreferences.JSON_PROPERTY_ALIAS_TABLE_NAME
})
...
public class NamedQueriesPreferences {
  ...
  public static final String JSON_PROPERTY_ALIAS_TABLE_NAME = "aliasTableName";
  @jakarta.annotation.Nullable
  ...
  public NamedQueriesPreferences aliasTableName(@jakarta.annotation.Nullable String aliasTableName) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ALIAS_TABLE_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_ALIAS_TABLE_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAliasTableName(@jakarta.annotation.Nullable String aliasTableName) {
    this.aliasTableName = aliasTableName;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dataless, namedQueriesPreferences.dataless) &&
        ...
        Objects.equals(this.aliasTableName, namedQueriesPreferences.aliasTableName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dataless, hideRestrictedData, cellAttributes, formatString, formatValues, meaninglessCells, textList, urlDrillThrough, memberIdentifierType, aliasTableName);
  }
  ...
  public String toString() {
    ...
    sb.append("    aliasTableName: ").append(toIndentedString(aliasTableName)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `aliasTableName` to the URL query string
    if (getAliasTableName() != null) {
      joiner.add(String.format("%saliasTableName%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAliasTableName()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
