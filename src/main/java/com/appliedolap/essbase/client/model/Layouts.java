 ...
 */
@JsonPropertyOrder({
  Layouts.JSON_PROPERTY_COUNT,
  Layouts.JSON_PROPERTY_ITEMS,
  Layouts.JSON_PROPERTY_TOTAL_RESULTS,
  Layouts.JSON_PROPERTY_HAS_MORE,
  Layouts.JSON_PROPERTY_LIMIT,
  Layouts.JSON_PROPERTY_PROPERTIES,
  Layouts.JSON_PROPERTY_OFFSET
})
...
public class Layouts {
  ...
  @jakarta.annotation.Nullable
  private List<LayoutMetadata> items = new ArrayList<>();
  ...
  public Layouts count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public Layouts items(@jakarta.annotation.Nullable List<LayoutMetadata> items) {
    this.items = items;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<LayoutMetadata> items) {
    this.items = items;
  }


  public Layouts totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public Layouts hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public Layouts limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public Layouts properties(@jakarta.annotation.Nullable Map<String, String> properties) {
  ...
  public Layouts offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  /**
   * Return true if this Layouts object is equal to o.
   */
  @Override
