 ...
 */
@JsonPropertyOrder({
  ScriptList.JSON_PROPERTY_ITEMS,
  ScriptList.JSON_PROPERTY_COUNT,
  ScriptList.JSON_PROPERTY_TOTAL_RESULTS,
  ScriptList.JSON_PROPERTY_HAS_MORE,
  ScriptList.JSON_PROPERTY_LIMIT,
  ScriptList.JSON_PROPERTY_PROPERTIES,
  ScriptList.JSON_PROPERTY_OFFSET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class ScriptList {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @jakarta.annotation.Nullable
  private List<Script> items = new ArrayList<>();
  ...
  public ScriptList items(@jakarta.annotation.Nullable List<Script> items) {
    this.items = items;
    return this;
  }

  public ScriptList addItemsItem(Script itemsItem) {
    if (this.items == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<Script> items) {
    this.items = items;
  }


  public ScriptList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public ScriptList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public ScriptList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public ScriptList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ScriptList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public ScriptList putPropertiesItem(String key, String propertiesItem) {
  ...
  public ScriptList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  /**
   * Return true if this ScriptList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ScriptList scriptList = (ScriptList) o;
    return Objects.equals(this.items, scriptList.items) &&
        Objects.equals(this.count, scriptList.count) &&
        Objects.equals(this.totalResults, scriptList.totalResults) &&
        Objects.equals(this.hasMore, scriptList.hasMore) &&
        Objects.equals(this.limit, scriptList.limit) &&
        Objects.equals(this.properties, scriptList.properties) &&
        Objects.equals(this.offset, scriptList.offset);
  }
