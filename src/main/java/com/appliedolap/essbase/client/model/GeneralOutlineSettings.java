...
@JsonPropertyOrder({
  ...
  GeneralOutlineSettings.JSON_PROPERTY_AUTO_CONFIGURE
})
...
public class GeneralOutlineSettings {
  ...
  public static final String JSON_PROPERTY_AUTO_CONFIGURE = "autoConfigure";
  @jakarta.annotation.Nullable
  ...
  public GeneralOutlineSettings autoConfigure(@jakarta.annotation.Nullable Boolean autoConfigure) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_AUTO_CONFIGURE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_AUTO_CONFIGURE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAutoConfigure(@jakarta.annotation.Nullable Boolean autoConfigure) {
    this.autoConfigure = autoConfigure;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.caseSensitiveMembers, generalOutlineSettings.caseSensitiveMembers) &&
        ...
        Objects.equals(this.autoConfigure, generalOutlineSettings.autoConfigure);
  }

  @Override
  public int hashCode() {
    return Objects.hash(caseSensitiveMembers, outlineType, allowDuplicateMemberNames, typeMeasuresEnabled, dateFormat, varyingAttributesEnabled, timeModified, autoConfigure);
  }
  ...
  public String toString() {
    ...
    sb.append("    autoConfigure: ").append(toIndentedString(autoConfigure)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `autoConfigure` to the URL query string
    if (getAutoConfigure() != null) {
      joiner.add(String.format("%sautoConfigure%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAutoConfigure()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
