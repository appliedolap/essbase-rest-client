 ...
 */
@JsonPropertyOrder({
  DimensionList.JSON_PROPERTY_ITEMS,
  DimensionList.JSON_PROPERTY_COUNT,
  DimensionList.JSON_PROPERTY_TOTAL_RESULTS,
  DimensionList.JSON_PROPERTY_HAS_MORE,
  DimensionList.JSON_PROPERTY_LIMIT,
  DimensionList.JSON_PROPERTY_PROPERTIES,
  DimensionList.JSON_PROPERTY_OFFSET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class DimensionList {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @jakarta.annotation.Nullable
  private List<DimensionBean> items = new ArrayList<>();
  ...
  public DimensionList items(@jakarta.annotation.Nullable List<DimensionBean> items) {
    this.items = items;
    return this;
  }

  public DimensionList addItemsItem(DimensionBean itemsItem) {
    if (this.items == null) {
  ...
  public List<DimensionBean> getItems() {
    return items;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<DimensionBean> items) {
    this.items = items;
  }


  public DimensionList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public DimensionList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public DimensionList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public DimensionList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public DimensionList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public DimensionList putPropertiesItem(String key, String propertiesItem) {
  ...
  public DimensionList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  /**
   * Return true if this DimensionList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DimensionList dimensionList = (DimensionList) o;
    return Objects.equals(this.items, dimensionList.items) &&
        Objects.equals(this.count, dimensionList.count) &&
        Objects.equals(this.totalResults, dimensionList.totalResults) &&
        Objects.equals(this.hasMore, dimensionList.hasMore) &&
        Objects.equals(this.limit, dimensionList.limit) &&
        Objects.equals(this.properties, dimensionList.properties) &&
        Objects.equals(this.offset, dimensionList.offset);
  }
