...
import com.appliedolap.essbase.client.model.ScenarioCubes;
 ...
 */
@JsonPropertyOrder({
  ScenarioCubesList.JSON_PROPERTY_ITEMS,
  ScenarioCubesList.JSON_PROPERTY_COUNT,
  ScenarioCubesList.JSON_PROPERTY_TOTAL_RESULTS,
  ScenarioCubesList.JSON_PROPERTY_HAS_MORE,
  ScenarioCubesList.JSON_PROPERTY_LIMIT,
  ScenarioCubesList.JSON_PROPERTY_PROPERTIES,
  ScenarioCubesList.JSON_PROPERTY_OFFSET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class ScenarioCubesList {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @jakarta.annotation.Nullable
  private List<ScenarioCubes> items = new ArrayList<>();
  ...
  public ScenarioCubesList() { 
  }

  public ScenarioCubesList items(@jakarta.annotation.Nullable List<ScenarioCubes> items) {
    this.items = items;
    return this;
  }

  public ScenarioCubesList addItemsItem(ScenarioCubes itemsItem) {
    if (this.items == null) {
  ...
  public List<ScenarioCubes> getItems() {
    return items;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<ScenarioCubes> items) {
    this.items = items;
  }


  public ScenarioCubesList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public ScenarioCubesList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public ScenarioCubesList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public ScenarioCubesList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ScenarioCubesList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public ScenarioCubesList putPropertiesItem(String key, String propertiesItem) {
  ...
  public ScenarioCubesList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  /**
   * Return true if this ScenarioCubesList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ScenarioCubesList scenarioCubesList = (ScenarioCubesList) o;
    return Objects.equals(this.items, scenarioCubesList.items) &&
        Objects.equals(this.count, scenarioCubesList.count) &&
        Objects.equals(this.totalResults, scenarioCubesList.totalResults) &&
        Objects.equals(this.hasMore, scenarioCubesList.hasMore) &&
        Objects.equals(this.limit, scenarioCubesList.limit) &&
        Objects.equals(this.properties, scenarioCubesList.properties) &&
        Objects.equals(this.offset, scenarioCubesList.offset);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScenarioCubesList {\n");
