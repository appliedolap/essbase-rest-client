...
public class ScenarioBean {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, scenarioUser, database, sandbox, dueDate, approvers, application, participants, description, useCalculatedValues, overdue, createdTime, submittedTime, appliedTime, refreshedTime, commentsCount, scripts, name, priority, id, state, owner);
  }
