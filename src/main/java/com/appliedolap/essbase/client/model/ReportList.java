 ...
 */
@JsonPropertyOrder({
  ReportList.JSON_PROPERTY_ITEMS,
  ReportList.JSON_PROPERTY_TOTAL_RESULTS,
  ReportList.JSON_PROPERTY_LIMIT,
  ReportList.JSON_PROPERTY_OFFSET,
  ReportList.JSON_PROPERTY_COUNT,
  ReportList.JSON_PROPERTY_HAS_MORE,
  ReportList.JSON_PROPERTY_PROPERTIES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class ReportList {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @jakarta.annotation.Nullable
  private List<ReportBean> items = new ArrayList<>();
  ...
  public ReportList items(@jakarta.annotation.Nullable List<ReportBean> items) {
    this.items = items;
    return this;
  }

  public ReportList addItemsItem(ReportBean itemsItem) {
    if (this.items == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<ReportBean> items) {
    this.items = items;
  }


  public ReportList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public ReportList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ReportList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  public ReportList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public ReportList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public ReportList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public ReportList putPropertiesItem(String key, String propertiesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, reportList.items) &&
        Objects.equals(this.totalResults, reportList.totalResults) &&
        Objects.equals(this.limit, reportList.limit) &&
        Objects.equals(this.offset, reportList.offset) &&
        Objects.equals(this.count, reportList.count) &&
        Objects.equals(this.hasMore, reportList.hasMore) &&
        Objects.equals(this.properties, reportList.properties);
  }
