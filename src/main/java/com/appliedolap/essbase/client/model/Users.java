 ...
 */
@JsonPropertyOrder({
  Users.JSON_PROPERTY_TOTAL_RESULTS,
  Users.JSON_PROPERTY_COUNT,
  Users.JSON_PROPERTY_LIMIT,
  Users.JSON_PROPERTY_OFFSET,
  Users.JSON_PROPERTY_ITEMS,
  Users.JSON_PROPERTY_HAS_MORE,
  Users.JSON_PROPERTY_PROPERTIES
})
...
public class Users {
  ...
  public Users totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public Users count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public Users limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public Users offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  public Users items(@jakarta.annotation.Nullable List<UserBean> items) {
    this.items = items;
    return this;
  }

  public Users addItemsItem(UserBean itemsItem) {
    if (this.items == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<UserBean> items) {
    this.items = items;
  }


  public Users hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public Users properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public Users putPropertiesItem(String key, String propertiesItem) {
  ...
  public boolean equals(Object o) {
    ...
    Users users = (Users) o;
    return Objects.equals(this.totalResults, users.totalResults) &&
        Objects.equals(this.count, users.count) &&
        Objects.equals(this.limit, users.limit) &&
        Objects.equals(this.offset, users.offset) &&
        Objects.equals(this.items, users.items) &&
        Objects.equals(this.hasMore, users.hasMore) &&
        Objects.equals(this.properties, users.properties);
  }
