 ...
 */
@JsonPropertyOrder({
  PropertyList.JSON_PROPERTY_ITEMS,
  PropertyList.JSON_PROPERTY_COUNT,
  PropertyList.JSON_PROPERTY_TOTAL_RESULTS,
  PropertyList.JSON_PROPERTY_HAS_MORE,
  PropertyList.JSON_PROPERTY_LIMIT,
  PropertyList.JSON_PROPERTY_PROPERTIES,
  PropertyList.JSON_PROPERTY_OFFSET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class PropertyList {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @jakarta.annotation.Nullable
  private List<PropertyEntry> items = new ArrayList<>();
  ...
  public PropertyList items(@jakarta.annotation.Nullable List<PropertyEntry> items) {
    this.items = items;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<PropertyEntry> items) {
    this.items = items;
  }


  public PropertyList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public PropertyList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public PropertyList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public PropertyList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public PropertyList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
  ...
  public PropertyList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  /**
   * Return true if this PropertyList object is equal to o.
   */
  @Override
