...
@JsonPropertyOrder({
  ...
  ParametersBean.JSON_PROPERTY_MEMBER_IDS,
  ...
  ParametersBean.JSON_PROPERTY_ALL_APP,
  ...
  ParametersBean.JSON_PROPERTY_SHADOW_APP_NAME,
  ParametersBean.JSON_PROPERTY_PRIMARY_APP_NAME,
  ParametersBean.JSON_PROPERTY_TIMEOUT_TO_FORCE_UNLOAD_APP,
  ParametersBean.JSON_PROPERTY_HIDE_SHADOW,
  ParametersBean.JSON_PROPERTY_WAIT_FOR_ONGOING_UPDATES_IN_SECS,
  ParametersBean.JSON_PROPERTY_REPORT_SCRIPT_FILENAME,
  ParametersBean.JSON_PROPERTY_LOCK_FOR_UPDATE,
  ParametersBean.JSON_PROPERTY_IS_SCRIPT_CONTENT,
  ParametersBean.JSON_PROPERTY_USE_CATALOG_PATH,
  ParametersBean.JSON_PROPERTY_EXPORTDATA,
  ParametersBean.JSON_PROPERTY_CUBE,
  ParametersBean.JSON_PROPERTY_FILETYPE,
  ParametersBean.JSON_PROPERTY_EXPORTPARTITIONS,
  ParametersBean.JSON_PROPERTY_EXPORTFILTERS,
  ParametersBean.JSON_PROPERTY_BACKUP_PATH,
  ParametersBean.JSON_PROPERTY_REST_ENCRY_PASSWORD,
  ParametersBean.JSON_PROPERTY_PIVOTDIMENSION,
  ParametersBean.JSON_PROPERTY_CATALOG_ZIP_PATH,
  ParametersBean.JSON_PROPERTY_PHYSICAL
})
...
public class ParametersBean {
  ...
  public static final String JSON_PROPERTY_ALL_APP = "allApp";
  @jakarta.annotation.Nullable
  ...
  @jakarta.annotation.Nullable
  private String timeoutToForceUnloadApp;

  public static final String JSON_PROPERTY_HIDE_SHADOW = "hideShadow";
  @jakarta.annotation.Nullable
  private String hideShadow;

  public static final String JSON_PROPERTY_WAIT_FOR_ONGOING_UPDATES_IN_SECS = "waitForOngoingUpdatesInSecs";
  @jakarta.annotation.Nullable
  private String waitForOngoingUpdatesInSecs;

  public static final String JSON_PROPERTY_REPORT_SCRIPT_FILENAME = "reportScriptFilename";
  @jakarta.annotation.Nullable
  private String reportScriptFilename;

  public static final String JSON_PROPERTY_LOCK_FOR_UPDATE = "lockForUpdate";
  @jakarta.annotation.Nullable
  private Boolean lockForUpdate;

  public static final String JSON_PROPERTY_IS_SCRIPT_CONTENT = "isScriptContent";
  @jakarta.annotation.Nullable
  private Boolean isScriptContent;

  public static final String JSON_PROPERTY_USE_CATALOG_PATH = "useCatalogPath";
  @jakarta.annotation.Nullable
  private Boolean useCatalogPath;

  public static final String JSON_PROPERTY_EXPORTDATA = "exportdata";
  @jakarta.annotation.Nullable
  ...
  public static final String JSON_PROPERTY_EXPORTPARTITIONS = "exportpartitions";
  @jakarta.annotation.Nullable
  private Boolean exportpartitions;

  public static final String JSON_PROPERTY_EXPORTFILTERS = "exportfilters";
  @jakarta.annotation.Nullable
  private Boolean exportfilters;

  public static final String JSON_PROPERTY_BACKUP_PATH = "backupPath";
  @jakarta.annotation.Nullable
  private String backupPath;

  public static final String JSON_PROPERTY_REST_ENCRY_PASSWORD = "restEncryPassword";
  @jakarta.annotation.Nullable
  private String restEncryPassword;

  public static final String JSON_PROPERTY_PIVOTDIMENSION = "pivotdimension";
  @jakarta.annotation.Nullable
  private String pivotdimension;

  public static final String JSON_PROPERTY_CATALOG_ZIP_PATH = "catalogZipPath";
  @jakarta.annotation.Nullable
  private String catalogZipPath;
  ...
  public ParametersBean memberIds(@jakarta.annotation.Nullable String memberIds) {
  ...
  @JsonProperty(JSON_PROPERTY_MEMBER_IDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMemberIds(@jakarta.annotation.Nullable String memberIds) {
    this.memberIds = memberIds;
  }
  ...
  public ParametersBean allApp(@jakarta.annotation.Nullable String allApp) {
    this.allApp = allApp;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ALL_APP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_ALL_APP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAllApp(@jakarta.annotation.Nullable String allApp) {
    this.allApp = allApp;
  }
  ...
  public ParametersBean shadowAppName(@jakarta.annotation.Nullable String shadowAppName) {
  ...
  @JsonProperty(JSON_PROPERTY_SHADOW_APP_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setShadowAppName(@jakarta.annotation.Nullable String shadowAppName) {
    this.shadowAppName = shadowAppName;
  }


  public ParametersBean primaryAppName(@jakarta.annotation.Nullable String primaryAppName) {
  ...
  @JsonProperty(JSON_PROPERTY_PRIMARY_APP_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPrimaryAppName(@jakarta.annotation.Nullable String primaryAppName) {
    this.primaryAppName = primaryAppName;
  }


  public ParametersBean timeoutToForceUnloadApp(@jakarta.annotation.Nullable String timeoutToForceUnloadApp) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public String getTimeoutToForceUnloadApp() {
    return timeoutToForceUnloadApp;
  }
  ...
  @JsonProperty(JSON_PROPERTY_TIMEOUT_TO_FORCE_UNLOAD_APP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTimeoutToForceUnloadApp(@jakarta.annotation.Nullable String timeoutToForceUnloadApp) {
    this.timeoutToForceUnloadApp = timeoutToForceUnloadApp;
  }


  public ParametersBean hideShadow(@jakarta.annotation.Nullable String hideShadow) {
  ...
  @JsonProperty(JSON_PROPERTY_HIDE_SHADOW)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHideShadow(@jakarta.annotation.Nullable String hideShadow) {
    this.hideShadow = hideShadow;
  }


  public ParametersBean waitForOngoingUpdatesInSecs(@jakarta.annotation.Nullable String waitForOngoingUpdatesInSecs) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public String getWaitForOngoingUpdatesInSecs() {
    return waitForOngoingUpdatesInSecs;
  }
  ...
  @JsonProperty(JSON_PROPERTY_WAIT_FOR_ONGOING_UPDATES_IN_SECS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setWaitForOngoingUpdatesInSecs(@jakarta.annotation.Nullable String waitForOngoingUpdatesInSecs) {
    this.waitForOngoingUpdatesInSecs = waitForOngoingUpdatesInSecs;
  }


  public ParametersBean reportScriptFilename(@jakarta.annotation.Nullable String reportScriptFilename) {
    this.reportScriptFilename = reportScriptFilename;
    return this;
  }

  /**
   * Get reportScriptFilename
   * @return reportScriptFilename
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_REPORT_SCRIPT_FILENAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public String getReportScriptFilename() {
    return reportScriptFilename;
  }
  ...
  @JsonProperty(JSON_PROPERTY_REPORT_SCRIPT_FILENAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReportScriptFilename(@jakarta.annotation.Nullable String reportScriptFilename) {
    this.reportScriptFilename = reportScriptFilename;
  }


  public ParametersBean lockForUpdate(@jakarta.annotation.Nullable Boolean lockForUpdate) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_LOCK_FOR_UPDATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_LOCK_FOR_UPDATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLockForUpdate(@jakarta.annotation.Nullable Boolean lockForUpdate) {
    this.lockForUpdate = lockForUpdate;
  }


  public ParametersBean isScriptContent(@jakarta.annotation.Nullable Boolean isScriptContent) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_IS_SCRIPT_CONTENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public Boolean getIsScriptContent() {
    return isScriptContent;
  }
  ...
  @JsonProperty(JSON_PROPERTY_IS_SCRIPT_CONTENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIsScriptContent(@jakarta.annotation.Nullable Boolean isScriptContent) {
    this.isScriptContent = isScriptContent;
  }


  public ParametersBean useCatalogPath(@jakarta.annotation.Nullable Boolean useCatalogPath) {
  ...
  /**
   * Get useCatalogPath
   * @return useCatalogPath
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_USE_CATALOG_PATH)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public Boolean getUseCatalogPath() {
    return useCatalogPath;
  }
  ...
  @JsonProperty(JSON_PROPERTY_USE_CATALOG_PATH)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUseCatalogPath(@jakarta.annotation.Nullable Boolean useCatalogPath) {
    this.useCatalogPath = useCatalogPath;
  }


  public ParametersBean exportdata(@jakarta.annotation.Nullable Boolean exportdata) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_EXPORTDATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_EXPORTDATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExportdata(@jakarta.annotation.Nullable Boolean exportdata) {
    this.exportdata = exportdata;
  }


  public ParametersBean cube(@jakarta.annotation.Nullable String cube) {
    this.cube = cube;
    return this;
  }
  ...
  public ParametersBean filetype(@jakarta.annotation.Nullable String filetype) {
  ...
  @JsonProperty(JSON_PROPERTY_FILETYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFiletype(@jakarta.annotation.Nullable String filetype) {
    this.filetype = filetype;
  }


  public ParametersBean exportpartitions(@jakarta.annotation.Nullable Boolean exportpartitions) {
    this.exportpartitions = exportpartitions;
    return this;
  }

  /**
   * Get exportpartitions
   * @return exportpartitions
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_EXPORTPARTITIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public Boolean getExportpartitions() {
    return exportpartitions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EXPORTPARTITIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExportpartitions(@jakarta.annotation.Nullable Boolean exportpartitions) {
    this.exportpartitions = exportpartitions;
  }


  public ParametersBean exportfilters(@jakarta.annotation.Nullable Boolean exportfilters) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_EXPORTFILTERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public Boolean getExportfilters() {
    return exportfilters;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EXPORTFILTERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExportfilters(@jakarta.annotation.Nullable Boolean exportfilters) {
    this.exportfilters = exportfilters;
  }


  public ParametersBean backupPath(@jakarta.annotation.Nullable String backupPath) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_BACKUP_PATH)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_BACKUP_PATH)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBackupPath(@jakarta.annotation.Nullable String backupPath) {
    this.backupPath = backupPath;
  }


  public ParametersBean restEncryPassword(@jakarta.annotation.Nullable String restEncryPassword) {
    this.restEncryPassword = restEncryPassword;
    return this;
  }

  /**
   * Get restEncryPassword
   * @return restEncryPassword
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_REST_ENCRY_PASSWORD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public String getRestEncryPassword() {
    return restEncryPassword;
  }
  ...
  @JsonProperty(JSON_PROPERTY_REST_ENCRY_PASSWORD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRestEncryPassword(@jakarta.annotation.Nullable String restEncryPassword) {
    this.restEncryPassword = restEncryPassword;
  }


  public ParametersBean pivotdimension(@jakarta.annotation.Nullable String pivotdimension) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_PIVOTDIMENSION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_PIVOTDIMENSION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPivotdimension(@jakarta.annotation.Nullable String pivotdimension) {
    this.pivotdimension = pivotdimension;
  }


  public ParametersBean catalogZipPath(@jakarta.annotation.Nullable String catalogZipPath) {
  ...
  /**
   * Get catalogZipPath
   * @return catalogZipPath
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_CATALOG_ZIP_PATH)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public String getCatalogZipPath() {
    return catalogZipPath;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CATALOG_ZIP_PATH)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCatalogZipPath(@jakarta.annotation.Nullable String catalogZipPath) {
    this.catalogZipPath = catalogZipPath;
  }


  public ParametersBean physical(@jakarta.annotation.Nullable Boolean physical) {
  ...
  @JsonProperty(JSON_PROPERTY_PHYSICAL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPhysical(@jakarta.annotation.Nullable Boolean physical) {
    this.physical = physical;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rule, parametersBean.rule) &&
        ...
        Objects.equals(this.memberIds, parametersBean.memberIds) &&
        ...
        Objects.equals(this.allApp, parametersBean.allApp) &&
        ...
        Objects.equals(this.shadowAppName, parametersBean.shadowAppName) &&
        Objects.equals(this.primaryAppName, parametersBean.primaryAppName) &&
        Objects.equals(this.timeoutToForceUnloadApp, parametersBean.timeoutToForceUnloadApp) &&
        Objects.equals(this.hideShadow, parametersBean.hideShadow) &&
        Objects.equals(this.waitForOngoingUpdatesInSecs, parametersBean.waitForOngoingUpdatesInSecs) &&
        Objects.equals(this.reportScriptFilename, parametersBean.reportScriptFilename) &&
        Objects.equals(this.lockForUpdate, parametersBean.lockForUpdate) &&
        Objects.equals(this.isScriptContent, parametersBean.isScriptContent) &&
        Objects.equals(this.useCatalogPath, parametersBean.useCatalogPath) &&
        Objects.equals(this.exportdata, parametersBean.exportdata) &&
        Objects.equals(this.cube, parametersBean.cube) &&
        Objects.equals(this.filetype, parametersBean.filetype) &&
        Objects.equals(this.exportpartitions, parametersBean.exportpartitions) &&
        Objects.equals(this.exportfilters, parametersBean.exportfilters) &&
        Objects.equals(this.backupPath, parametersBean.backupPath) &&
        Objects.equals(this.restEncryPassword, parametersBean.restEncryPassword) &&
        Objects.equals(this.pivotdimension, parametersBean.pivotdimension) &&
        Objects.equals(this.catalogZipPath, parametersBean.catalogZipPath) &&
        Objects.equals(this.physical, parametersBean.physical);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rule, _file, abortOnError, restructureOption, forceDimBuild, script, option, loaddata, useConnection, connection, user, password, calc, buildMethod, data, memberIds, zipFileName, skipdata, threads, overwrite, lcmImportFromStorage, analyzeFileName, analyzeSheetName, deleteExcelOnSuccess, catalogExcelPath, importExcelFileName, recreateApplication, createFiles, executeScript, buildOption, copyToStorage, filesystemcopy, dataLevel, columnFormat, targetApplicationName, partialDataExpression, allApp, includeServerLevel, enableSandboxing, dbType, dimDesignationMode, unstructuredAnalysis, ratioToStop, basedOnQueryData, enableAlternateRollups, compress, generateArtifactList, artifactList, verbose, disasterRecovery, force, backupType, appId, timestamp, maxParallel, selectedDimensions, rtsv, bufferId, bufferIds, commitOption, actionType, termOption, discoverDimensionTables, exportDynamicBlocks, shadowAppName, primaryAppName, timeoutToForceUnloadApp, hideShadow, waitForOngoingUpdatesInSecs, reportScriptFilename, lockForUpdate, isScriptContent, useCatalogPath, exportdata, cube, filetype, exportpartitions, exportfilters, backupPath, restEncryPassword, pivotdimension, catalogZipPath, physical);
  }
  ...
  public String toString() {
    ...
    sb.append("    allApp: ").append(toIndentedString(allApp)).append("\n");
    ...
    sb.append("    reportScriptFilename: ").append(toIndentedString(reportScriptFilename)).append("\n");
    sb.append("    lockForUpdate: ").append(toIndentedString(lockForUpdate)).append("\n");
    sb.append("    isScriptContent: ").append(toIndentedString(isScriptContent)).append("\n");
    sb.append("    useCatalogPath: ").append(toIndentedString(useCatalogPath)).append("\n");
    ...
    sb.append("    exportpartitions: ").append(toIndentedString(exportpartitions)).append("\n");
    sb.append("    exportfilters: ").append(toIndentedString(exportfilters)).append("\n");
    sb.append("    backupPath: ").append(toIndentedString(backupPath)).append("\n");
    sb.append("    restEncryPassword: ").append(toIndentedString(restEncryPassword)).append("\n");
    sb.append("    pivotdimension: ").append(toIndentedString(pivotdimension)).append("\n");
    sb.append("    catalogZipPath: ").append(toIndentedString(catalogZipPath)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMemberIds() != null) {
      joiner.add(String.format("%smemberIds%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getMemberIds()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    // add `allApp` to the URL query string
    if (getAllApp() != null) {
      joiner.add(String.format("%sallApp%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAllApp()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    // add `reportScriptFilename` to the URL query string
    if (getReportScriptFilename() != null) {
      joiner.add(String.format("%sreportScriptFilename%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getReportScriptFilename()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `lockForUpdate` to the URL query string
    if (getLockForUpdate() != null) {
      joiner.add(String.format("%slockForUpdate%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getLockForUpdate()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `isScriptContent` to the URL query string
    if (getIsScriptContent() != null) {
      joiner.add(String.format("%sisScriptContent%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getIsScriptContent()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `useCatalogPath` to the URL query string
    if (getUseCatalogPath() != null) {
      joiner.add(String.format("%suseCatalogPath%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getUseCatalogPath()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `exportdata` to the URL query string
    if (getExportdata() != null) {
      joiner.add(String.format("%sexportdata%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getExportdata()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getFiletype() != null) {
      joiner.add(String.format("%sfiletype%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getFiletype()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `exportpartitions` to the URL query string
    if (getExportpartitions() != null) {
      joiner.add(String.format("%sexportpartitions%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getExportpartitions()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `exportfilters` to the URL query string
    if (getExportfilters() != null) {
      joiner.add(String.format("%sexportfilters%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getExportfilters()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `backupPath` to the URL query string
    if (getBackupPath() != null) {
      joiner.add(String.format("%sbackupPath%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getBackupPath()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `restEncryPassword` to the URL query string
    if (getRestEncryPassword() != null) {
      joiner.add(String.format("%srestEncryPassword%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getRestEncryPassword()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `pivotdimension` to the URL query string
    if (getPivotdimension() != null) {
      joiner.add(String.format("%spivotdimension%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPivotdimension()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `catalogZipPath` to the URL query string
    if (getCatalogZipPath() != null) {
      joiner.add(String.format("%scatalogZipPath%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCatalogZipPath()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `physical` to the URL query string
    if (getPhysical() != null) {
      joiner.add(String.format("%sphysical%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPhysical()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
