 ...
 */
@JsonPropertyOrder({
  Suppression.JSON_PROPERTY_MISSING,
  Suppression.JSON_PROPERTY_INVALID,
  Suppression.JSON_PROPERTY_DERIVED,
  Suppression.JSON_PROPERTY_ZERO,
  Suppression.JSON_PROPERTY_UNDER_SCORE,
  Suppression.JSON_PROPERTY_NO_ACCESS,
  Suppression.JSON_PROPERTY_EMPTY_BLOCKS,
  Suppression.JSON_PROPERTY_ERROR
})
...
public class Suppression {
  ...
  public Suppression missing(@jakarta.annotation.Nullable Boolean missing) {
  ...
  public Suppression invalid(@jakarta.annotation.Nullable Boolean invalid) {
  ...
  public Suppression derived(@jakarta.annotation.Nullable Boolean derived) {
  ...
  public Suppression zero(@jakarta.annotation.Nullable Boolean zero) {
    this.zero = zero;
    return this;
  }
  ...
  public Suppression underScore(@jakarta.annotation.Nullable Boolean underScore) {
  ...
  public Suppression noAccess(@jakarta.annotation.Nullable Boolean noAccess) {
  ...
  public Suppression emptyBlocks(@jakarta.annotation.Nullable Boolean emptyBlocks) {
  ...
  public Suppression error(@jakarta.annotation.Nullable Boolean error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.missing, suppression.missing) &&
        Objects.equals(this.invalid, suppression.invalid) &&
        Objects.equals(this.derived, suppression.derived) &&
        Objects.equals(this.zero, suppression.zero) &&
        Objects.equals(this.underScore, suppression.underScore) &&
        Objects.equals(this.noAccess, suppression.noAccess) &&
        Objects.equals(this.emptyBlocks, suppression.emptyBlocks) &&
        Objects.equals(this.error, suppression.error);
  }

  @Override
  public int hashCode() {
    return Objects.hash(missing, invalid, derived, zero, underScore, noAccess, emptyBlocks, error);
  }
