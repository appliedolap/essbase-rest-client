 ...
 */
@JsonPropertyOrder({
  ServiceProvisionReportItem.JSON_PROPERTY_ROLES
})
...
public class ServiceProvisionReportItem {
  ...
  public ServiceProvisionReportItem() { 
  }

  public ServiceProvisionReportItem roles(@jakarta.annotation.Nullable ProvisionReportItemList roles) {
    this.roles = roles;
    return this;
  }
  ...
  /**
   * Return true if this ServiceProvisionReportItem object is equal to o.
   */
  @Override
