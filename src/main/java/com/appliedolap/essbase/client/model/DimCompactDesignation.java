...
@JsonPropertyOrder({
  ...
  DimCompactDesignation.JSON_PROPERTY_PARENT_COLUMN_ID,
...
public class DimCompactDesignation {
  ...
  public static final String JSON_PROPERTY_PARENT_COLUMN_ID = "parentColumnId";
  @jakarta.annotation.Nullable
  ...
  public DimCompactDesignation parentColumnId(@jakarta.annotation.Nullable Integer parentColumnId) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_PARENT_COLUMN_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_PARENT_COLUMN_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setParentColumnId(@jakarta.annotation.Nullable Integer parentColumnId) {
    this.parentColumnId = parentColumnId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.query, dimCompactDesignation.query) &&
        ...
        Objects.equals(this.parentColumnId, dimCompactDesignation.parentColumnId) &&
        Objects.equals(this.fkcolumnNumber, dimCompactDesignation.fkcolumnNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(query, essbaseConnection, genNames, colNames, dimGenColumns, attribute, dimJoin, dimName, attNames, columnTypes, uniqCount, headerText, parentColumnId, fkcolumnNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("    parentColumnId: ").append(toIndentedString(parentColumnId)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `parentColumnId` to the URL query string
    if (getParentColumnId() != null) {
      joiner.add(String.format("%sparentColumnId%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getParentColumnId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
