 ...
 */
@JsonPropertyOrder({
  PartitionList.JSON_PROPERTY_ITEMS,
  PartitionList.JSON_PROPERTY_OFFSET,
  PartitionList.JSON_PROPERTY_LIMIT,
  PartitionList.JSON_PROPERTY_TOTAL_RESULTS,
  PartitionList.JSON_PROPERTY_COUNT,
  PartitionList.JSON_PROPERTY_HAS_MORE,
  PartitionList.JSON_PROPERTY_PROPERTIES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class PartitionList {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @jakarta.annotation.Nullable
  private List<PartitionBean> items = new ArrayList<>();
  ...
  public PartitionList items(@jakarta.annotation.Nullable List<PartitionBean> items) {
    this.items = items;
    return this;
  }

  public PartitionList addItemsItem(PartitionBean itemsItem) {
    if (this.items == null) {
  ...
  public List<PartitionBean> getItems() {
    return items;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<PartitionBean> items) {
    this.items = items;
  }


  public PartitionList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  public PartitionList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public PartitionList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public PartitionList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public PartitionList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public PartitionList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public PartitionList putPropertiesItem(String key, String propertiesItem) {
  ...
  /**
   * Return true if this PartitionList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, partitionList.items) &&
        Objects.equals(this.offset, partitionList.offset) &&
        Objects.equals(this.limit, partitionList.limit) &&
        Objects.equals(this.totalResults, partitionList.totalResults) &&
        Objects.equals(this.count, partitionList.count) &&
        Objects.equals(this.hasMore, partitionList.hasMore) &&
        Objects.equals(this.properties, partitionList.properties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(items, offset, limit, totalResults, count, hasMore, properties);
  }
