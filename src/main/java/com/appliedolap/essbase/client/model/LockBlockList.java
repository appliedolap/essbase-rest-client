 ...
 */
@JsonPropertyOrder({
  LockBlockList.JSON_PROPERTY_ITEMS,
  LockBlockList.JSON_PROPERTY_TOTAL_RESULTS,
  LockBlockList.JSON_PROPERTY_LIMIT,
  LockBlockList.JSON_PROPERTY_OFFSET,
  LockBlockList.JSON_PROPERTY_COUNT,
  LockBlockList.JSON_PROPERTY_HAS_MORE,
  LockBlockList.JSON_PROPERTY_PROPERTIES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class LockBlockList {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @jakarta.annotation.Nullable
  private List<LockBlock> items = new ArrayList<>();
  ...
  public LockBlockList() { 
  }

  public LockBlockList items(@jakarta.annotation.Nullable List<LockBlock> items) {
    this.items = items;
    return this;
  }

  public LockBlockList addItemsItem(LockBlock itemsItem) {
    if (this.items == null) {
  ...
  public List<LockBlock> getItems() {
    return items;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<LockBlock> items) {
    this.items = items;
  }


  public LockBlockList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public LockBlockList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public LockBlockList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  public LockBlockList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public LockBlockList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public LockBlockList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public LockBlockList putPropertiesItem(String key, String propertiesItem) {
  ...
  /**
   * Return true if this LockBlockList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    LockBlockList lockBlockList = (LockBlockList) o;
    return Objects.equals(this.items, lockBlockList.items) &&
        Objects.equals(this.totalResults, lockBlockList.totalResults) &&
        Objects.equals(this.limit, lockBlockList.limit) &&
        Objects.equals(this.offset, lockBlockList.offset) &&
        Objects.equals(this.count, lockBlockList.count) &&
        Objects.equals(this.hasMore, lockBlockList.hasMore) &&
        Objects.equals(this.properties, lockBlockList.properties);
  }
