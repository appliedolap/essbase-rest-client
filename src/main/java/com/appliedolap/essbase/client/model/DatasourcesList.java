 ...
 */
@JsonPropertyOrder({
  DatasourcesList.JSON_PROPERTY_ITEMS,
  DatasourcesList.JSON_PROPERTY_TOTAL_RESULTS,
  DatasourcesList.JSON_PROPERTY_LIMIT,
  DatasourcesList.JSON_PROPERTY_OFFSET,
  DatasourcesList.JSON_PROPERTY_COUNT,
  DatasourcesList.JSON_PROPERTY_HAS_MORE,
  DatasourcesList.JSON_PROPERTY_PROPERTIES
})
...
public class DatasourcesList {
  ...
  public DatasourcesList items(@jakarta.annotation.Nullable List<Datasource> items) {
    this.items = items;
    return this;
  }

  public DatasourcesList addItemsItem(Datasource itemsItem) {
    if (this.items == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<Datasource> items) {
    this.items = items;
  }


  public DatasourcesList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public DatasourcesList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public DatasourcesList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  public DatasourcesList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public DatasourcesList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public DatasourcesList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public DatasourcesList putPropertiesItem(String key, String propertiesItem) {
  ...
  /**
   * Return true if this DatasourcesList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DatasourcesList datasourcesList = (DatasourcesList) o;
    return Objects.equals(this.items, datasourcesList.items) &&
        Objects.equals(this.totalResults, datasourcesList.totalResults) &&
        Objects.equals(this.limit, datasourcesList.limit) &&
        Objects.equals(this.offset, datasourcesList.offset) &&
        Objects.equals(this.count, datasourcesList.count) &&
        Objects.equals(this.hasMore, datasourcesList.hasMore) &&
        Objects.equals(this.properties, datasourcesList.properties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatasourcesList {\n");
