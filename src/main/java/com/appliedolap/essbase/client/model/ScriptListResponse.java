 ...
 */
@JsonPropertyOrder({
  ScriptListResponse.JSON_PROPERTY_ITEMS,
  ScriptListResponse.JSON_PROPERTY_COUNT,
  ScriptListResponse.JSON_PROPERTY_TOTAL_RESULTS,
  ScriptListResponse.JSON_PROPERTY_HAS_MORE,
  ScriptListResponse.JSON_PROPERTY_LIMIT,
  ScriptListResponse.JSON_PROPERTY_PROPERTIES,
  ScriptListResponse.JSON_PROPERTY_OFFSET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class ScriptListResponse {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @jakarta.annotation.Nullable
  private List<ScriptBean> items = new ArrayList<>();
  ...
  public ScriptListResponse items(@jakarta.annotation.Nullable List<ScriptBean> items) {
    this.items = items;
    return this;
  }

  public ScriptListResponse addItemsItem(ScriptBean itemsItem) {
    if (this.items == null) {
  ...
  public List<ScriptBean> getItems() {
    return items;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<ScriptBean> items) {
    this.items = items;
  }


  public ScriptListResponse count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public ScriptListResponse totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public ScriptListResponse hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public ScriptListResponse limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ScriptListResponse properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public ScriptListResponse putPropertiesItem(String key, String propertiesItem) {
  ...
  public ScriptListResponse offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  /**
   * Return true if this ScriptListResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ScriptListResponse scriptListResponse = (ScriptListResponse) o;
    return Objects.equals(this.items, scriptListResponse.items) &&
        Objects.equals(this.count, scriptListResponse.count) &&
        Objects.equals(this.totalResults, scriptListResponse.totalResults) &&
        Objects.equals(this.hasMore, scriptListResponse.hasMore) &&
        Objects.equals(this.limit, scriptListResponse.limit) &&
        Objects.equals(this.properties, scriptListResponse.properties) &&
        Objects.equals(this.offset, scriptListResponse.offset);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScriptListResponse {\n");
