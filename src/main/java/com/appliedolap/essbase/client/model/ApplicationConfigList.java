 ...
 */
@JsonPropertyOrder({
  ApplicationConfigList.JSON_PROPERTY_ITEMS,
  ApplicationConfigList.JSON_PROPERTY_COUNT,
  ApplicationConfigList.JSON_PROPERTY_TOTAL_RESULTS,
  ApplicationConfigList.JSON_PROPERTY_HAS_MORE,
  ApplicationConfigList.JSON_PROPERTY_LIMIT,
  ApplicationConfigList.JSON_PROPERTY_PROPERTIES,
  ApplicationConfigList.JSON_PROPERTY_OFFSET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class ApplicationConfigList {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @jakarta.annotation.Nullable
  private List<ApplicationConfigEntry> items = new ArrayList<>();
  ...
  public ApplicationConfigList() { 
  }

  public ApplicationConfigList items(@jakarta.annotation.Nullable List<ApplicationConfigEntry> items) {
    this.items = items;
    return this;
  }

  public ApplicationConfigList addItemsItem(ApplicationConfigEntry itemsItem) {
    if (this.items == null) {
  ...
  public List<ApplicationConfigEntry> getItems() {
    return items;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<ApplicationConfigEntry> items) {
    this.items = items;
  }


  public ApplicationConfigList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public ApplicationConfigList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public ApplicationConfigList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public ApplicationConfigList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ApplicationConfigList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public ApplicationConfigList putPropertiesItem(String key, String propertiesItem) {
  ...
  public ApplicationConfigList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  /**
   * Return true if this ApplicationConfigList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ApplicationConfigList applicationConfigList = (ApplicationConfigList) o;
    return Objects.equals(this.items, applicationConfigList.items) &&
        Objects.equals(this.count, applicationConfigList.count) &&
        Objects.equals(this.totalResults, applicationConfigList.totalResults) &&
        Objects.equals(this.hasMore, applicationConfigList.hasMore) &&
        Objects.equals(this.limit, applicationConfigList.limit) &&
        Objects.equals(this.properties, applicationConfigList.properties) &&
        Objects.equals(this.offset, applicationConfigList.offset);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicationConfigList {\n");
