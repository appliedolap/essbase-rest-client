...
public class Dimension {
  ...
  public enum AggregateLevelUsageEnum {
    ...
    ALLLEVELS(String.valueOf("ALLLEVELS")),
    
    NOAGGREGATION(String.valueOf("NOAGGREGATION")),
    
    TOPLEVELONLY(String.valueOf("TOPLEVELONLY")),
    
    NOINTERMEDIATELEVELS(String.valueOf("NOINTERMEDIATELEVELS")),
    
    BOTTOMLEVELONLY(String.valueOf("BOTTOMLEVELONLY"));

    private String value;

    AggregateLevelUsageEnum(String value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static AggregateLevelUsageEnum fromValue(String value) {
      for (AggregateLevelUsageEnum b : AggregateLevelUsageEnum.values()) {
  ...
  @jakarta.annotation.Nullable
  private AggregateLevelUsageEnum aggregateLevelUsage;
  ...
  public enum UpdateOptionEnum {
    ...
    RESET_DIMENSION(String.valueOf("RESET_DIMENSION"));
  ...
  public Dimension aggregateLevelUsage(@jakarta.annotation.Nullable AggregateLevelUsageEnum aggregateLevelUsage) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public AggregateLevelUsageEnum getAggregateLevelUsage() {
    return aggregateLevelUsage;
  }
  ...
  @JsonProperty(JSON_PROPERTY_AGGREGATE_LEVEL_USAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAggregateLevelUsage(@jakarta.annotation.Nullable AggregateLevelUsageEnum aggregateLevelUsage) {
    this.aggregateLevelUsage = aggregateLevelUsage;
  }
