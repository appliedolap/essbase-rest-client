 ...
 */
@JsonPropertyOrder({
  Preference.JSON_PROPERTY_LINKS
})
...
public class Preference {
  ...
  public Preference links(@jakarta.annotation.Nullable List<Link> links) {
    this.links = links;
    return this;
  }

  public Preference addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  /**
   * Return true if this Preference object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, preference.links);
  }
