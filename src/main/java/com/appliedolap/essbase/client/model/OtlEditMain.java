...
import com.appliedolap.essbase.client.model.OtlEditMainEditActionsInner;
...
public class OtlEditMain {
  ...
  private List<OtlEditMainEditActionsInner> editActions = new ArrayList<>();
  ...
  public OtlEditMain editActions(@jakarta.annotation.Nullable List<OtlEditMainEditActionsInner> editActions) {
    this.editActions = editActions;
    return this;
  }

  public OtlEditMain addEditActionsItem(OtlEditMainEditActionsInner editActionsItem) {
  ...
  public List<OtlEditMainEditActionsInner> getEditActions() {
    return editActions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EDIT_ACTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEditActions(@jakarta.annotation.Nullable List<OtlEditMainEditActionsInner> editActions) {
    this.editActions = editActions;
  }
