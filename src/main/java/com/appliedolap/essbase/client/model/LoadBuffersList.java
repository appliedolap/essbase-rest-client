 ...
 */
@JsonPropertyOrder({
  LoadBuffersList.JSON_PROPERTY_ITEMS,
  LoadBuffersList.JSON_PROPERTY_TOTAL_RESULTS,
  LoadBuffersList.JSON_PROPERTY_COUNT,
  LoadBuffersList.JSON_PROPERTY_HAS_MORE,
  LoadBuffersList.JSON_PROPERTY_LIMIT,
  LoadBuffersList.JSON_PROPERTY_PROPERTIES,
  LoadBuffersList.JSON_PROPERTY_OFFSET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class LoadBuffersList {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @jakarta.annotation.Nullable
  private List<DataLoadBuffer> items = new ArrayList<>();
  ...
  public LoadBuffersList() { 
  }

  public LoadBuffersList items(@jakarta.annotation.Nullable List<DataLoadBuffer> items) {
    this.items = items;
    return this;
  }

  public LoadBuffersList addItemsItem(DataLoadBuffer itemsItem) {
    if (this.items == null) {
  ...
  public List<DataLoadBuffer> getItems() {
    return items;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<DataLoadBuffer> items) {
    this.items = items;
  }


  public LoadBuffersList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public LoadBuffersList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public LoadBuffersList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public LoadBuffersList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public LoadBuffersList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public LoadBuffersList putPropertiesItem(String key, String propertiesItem) {
  ...
  public LoadBuffersList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  /**
   * Return true if this LoadBuffersList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    LoadBuffersList loadBuffersList = (LoadBuffersList) o;
    return Objects.equals(this.items, loadBuffersList.items) &&
        Objects.equals(this.totalResults, loadBuffersList.totalResults) &&
        Objects.equals(this.count, loadBuffersList.count) &&
        Objects.equals(this.hasMore, loadBuffersList.hasMore) &&
        Objects.equals(this.limit, loadBuffersList.limit) &&
        Objects.equals(this.properties, loadBuffersList.properties) &&
        Objects.equals(this.offset, loadBuffersList.offset);
  }

  @Override
  public int hashCode() {
    return Objects.hash(items, totalResults, count, hasMore, limit, properties, offset);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LoadBuffersList {\n");
