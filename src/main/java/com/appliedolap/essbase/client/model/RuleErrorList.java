...
import com.appliedolap.essbase.client.model.RuleError;
 ...
 */
@JsonPropertyOrder({
  RuleErrorList.JSON_PROPERTY_ITEMS,
  RuleErrorList.JSON_PROPERTY_TOTAL_RESULTS,
  RuleErrorList.JSON_PROPERTY_LIMIT,
  RuleErrorList.JSON_PROPERTY_OFFSET,
  RuleErrorList.JSON_PROPERTY_COUNT,
  RuleErrorList.JSON_PROPERTY_HAS_MORE,
  RuleErrorList.JSON_PROPERTY_PROPERTIES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class RuleErrorList {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @jakarta.annotation.Nullable
  private List<RuleError> items = new ArrayList<>();
  ...
  public RuleErrorList items(@jakarta.annotation.Nullable List<RuleError> items) {
    this.items = items;
    return this;
  }

  public RuleErrorList addItemsItem(RuleError itemsItem) {
    if (this.items == null) {
  ...
  public List<RuleError> getItems() {
    return items;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<RuleError> items) {
    this.items = items;
  }


  public RuleErrorList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public RuleErrorList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public RuleErrorList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  public RuleErrorList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public RuleErrorList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public RuleErrorList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public RuleErrorList putPropertiesItem(String key, String propertiesItem) {
  ...
  /**
   * Return true if this RuleErrorList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RuleErrorList ruleErrorList = (RuleErrorList) o;
    return Objects.equals(this.items, ruleErrorList.items) &&
        Objects.equals(this.totalResults, ruleErrorList.totalResults) &&
        Objects.equals(this.limit, ruleErrorList.limit) &&
        Objects.equals(this.offset, ruleErrorList.offset) &&
        Objects.equals(this.count, ruleErrorList.count) &&
        Objects.equals(this.hasMore, ruleErrorList.hasMore) &&
        Objects.equals(this.properties, ruleErrorList.properties);
  }
