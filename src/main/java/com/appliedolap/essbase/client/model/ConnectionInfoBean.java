...
@JsonPropertyOrder({
  ...
  ConnectionInfoBean.JSON_PROPERTY_SCHEMA_NAME,
  ConnectionInfoBean.JSON_PROPERTY_FACT_TABLE_NAME,
  ConnectionInfoBean.JSON_PROPERTY_IS_FACT_MANAGED_BY_FEDERATED_CUBE,
...
public class ConnectionInfoBean {
  ...
  public static final String JSON_PROPERTY_FACT_TABLE_NAME = "factTableName";
  @jakarta.annotation.Nullable
  ...
  public ConnectionInfoBean schemaName(@jakarta.annotation.Nullable String schemaName) {
  ...
  @JsonProperty(JSON_PROPERTY_SCHEMA_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSchemaName(@jakarta.annotation.Nullable String schemaName) {
    this.schemaName = schemaName;
  }


  public ConnectionInfoBean factTableName(@jakarta.annotation.Nullable String factTableName) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_FACT_TABLE_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_FACT_TABLE_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFactTableName(@jakarta.annotation.Nullable String factTableName) {
    this.factTableName = factTableName;
  }


  public ConnectionInfoBean isFactManagedByFederatedCube(@jakarta.annotation.Nullable Boolean isFactManagedByFederatedCube) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.connectionName, connectionInfoBean.connectionName) &&
        ...
        Objects.equals(this.schemaName, connectionInfoBean.schemaName) &&
        Objects.equals(this.factTableName, connectionInfoBean.factTableName) &&
        Objects.equals(this.isFactManagedByFederatedCube, connectionInfoBean.isFactManagedByFederatedCube) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(connectionName, serverName, userName, password, description, applicationName, databaseName, datasourceName, measuresDimensionName, schemaName, factTableName, isFactManagedByFederatedCube, essbaseToColumnMap, essbaseToDataSourceMap, alterCredentials, applicationLevelConnection, applicationLevelDatasource);
  }
  ...
  public String toString() {
    ...
    sb.append("    factTableName: ").append(toIndentedString(factTableName)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `schemaName` to the URL query string
    if (getSchemaName() != null) {
      joiner.add(String.format("%sschemaName%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getSchemaName()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `factTableName` to the URL query string
    if (getFactTableName() != null) {
      joiner.add(String.format("%sfactTableName%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getFactTableName()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
