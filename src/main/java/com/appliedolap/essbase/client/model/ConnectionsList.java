 ...
 */
@JsonPropertyOrder({
  ConnectionsList.JSON_PROPERTY_ITEMS,
  ConnectionsList.JSON_PROPERTY_TOTAL_RESULTS,
  ConnectionsList.JSON_PROPERTY_LIMIT,
  ConnectionsList.JSON_PROPERTY_OFFSET,
  ConnectionsList.JSON_PROPERTY_COUNT,
  ConnectionsList.JSON_PROPERTY_HAS_MORE,
  ConnectionsList.JSON_PROPERTY_PROPERTIES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class ConnectionsList {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @jakarta.annotation.Nullable
  private List<Connection> items = new ArrayList<>();
  ...
  public ConnectionsList items(@jakarta.annotation.Nullable List<Connection> items) {
    this.items = items;
    return this;
  }

  public ConnectionsList addItemsItem(Connection itemsItem) {
    if (this.items == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<Connection> items) {
    this.items = items;
  }


  public ConnectionsList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public ConnectionsList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ConnectionsList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  public ConnectionsList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public ConnectionsList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public ConnectionsList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public ConnectionsList putPropertiesItem(String key, String propertiesItem) {
  ...
  /**
   * Return true if this ConnectionsList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, connectionsList.items) &&
        Objects.equals(this.totalResults, connectionsList.totalResults) &&
        Objects.equals(this.limit, connectionsList.limit) &&
        Objects.equals(this.offset, connectionsList.offset) &&
        Objects.equals(this.count, connectionsList.count) &&
        Objects.equals(this.hasMore, connectionsList.hasMore) &&
        Objects.equals(this.properties, connectionsList.properties);
  }
