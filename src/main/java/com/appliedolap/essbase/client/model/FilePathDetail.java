 ...
 */
@JsonPropertyOrder({
  FilePathDetail.JSON_PROPERTY_TO,
  FilePathDetail.JSON_PROPERTY_FROM
})
...
public class FilePathDetail {
  ...
  public FilePathDetail() { 
  }

  public FilePathDetail to(@jakarta.annotation.Nullable String to) {
    this.to = to;
    return this;
  }
  ...
  public FilePathDetail from(@jakarta.annotation.Nullable String from) {
    this.from = from;
    return this;
  }
  ...
  /**
   * Return true if this FilePathDetail object is equal to o.
   */
  @Override
