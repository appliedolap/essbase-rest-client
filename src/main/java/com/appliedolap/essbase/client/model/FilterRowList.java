 ...
 */
@JsonPropertyOrder({
  FilterRowList.JSON_PROPERTY_ITEMS,
  FilterRowList.JSON_PROPERTY_COUNT,
  FilterRowList.JSON_PROPERTY_TOTAL_RESULTS,
  FilterRowList.JSON_PROPERTY_HAS_MORE,
  FilterRowList.JSON_PROPERTY_LIMIT,
  FilterRowList.JSON_PROPERTY_PROPERTIES,
  FilterRowList.JSON_PROPERTY_OFFSET
})
...
public class FilterRowList {
  ...
  public FilterRowList() { 
  }

  public FilterRowList items(@jakarta.annotation.Nullable List<FilterRow> items) {
    this.items = items;
    return this;
  }

  public FilterRowList addItemsItem(FilterRow itemsItem) {
    if (this.items == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<FilterRow> items) {
    this.items = items;
  }


  public FilterRowList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public FilterRowList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public FilterRowList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public FilterRowList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public FilterRowList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public FilterRowList putPropertiesItem(String key, String propertiesItem) {
  ...
  public FilterRowList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  /**
   * Return true if this FilterRowList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FilterRowList filterRowList = (FilterRowList) o;
    return Objects.equals(this.items, filterRowList.items) &&
        Objects.equals(this.count, filterRowList.count) &&
        Objects.equals(this.totalResults, filterRowList.totalResults) &&
        Objects.equals(this.hasMore, filterRowList.hasMore) &&
        Objects.equals(this.limit, filterRowList.limit) &&
        Objects.equals(this.properties, filterRowList.properties) &&
        Objects.equals(this.offset, filterRowList.offset);
  }
