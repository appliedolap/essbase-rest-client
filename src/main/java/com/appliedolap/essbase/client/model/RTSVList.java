 ...
 */
@JsonPropertyOrder({
  RTSVList.JSON_PROPERTY_TOTAL_RESULTS,
  RTSVList.JSON_PROPERTY_COUNT,
  RTSVList.JSON_PROPERTY_LIMIT,
  RTSVList.JSON_PROPERTY_OFFSET,
  RTSVList.JSON_PROPERTY_ITEMS,
  RTSVList.JSON_PROPERTY_HAS_MORE,
  RTSVList.JSON_PROPERTY_PROPERTIES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class RTSVList {
  ...
  @jakarta.annotation.Nullable
  private List<RTSV> items = new ArrayList<>();
  ...
  public RTSVList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public RTSVList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public RTSVList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public RTSVList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  public RTSVList items(@jakarta.annotation.Nullable List<RTSV> items) {
    this.items = items;
    return this;
  }

  public RTSVList addItemsItem(RTSV itemsItem) {
    if (this.items == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<RTSV> items) {
    this.items = items;
  }


  public RTSVList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public RTSVList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public RTSVList putPropertiesItem(String key, String propertiesItem) {
  ...
  /**
   * Return true if this RTSVList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RTSVList rtSVList = (RTSVList) o;
    return Objects.equals(this.totalResults, rtSVList.totalResults) &&
        Objects.equals(this.count, rtSVList.count) &&
        Objects.equals(this.limit, rtSVList.limit) &&
        Objects.equals(this.offset, rtSVList.offset) &&
        Objects.equals(this.items, rtSVList.items) &&
        Objects.equals(this.hasMore, rtSVList.hasMore) &&
        Objects.equals(this.properties, rtSVList.properties);
  }
