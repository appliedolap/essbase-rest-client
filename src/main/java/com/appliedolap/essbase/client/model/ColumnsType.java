...
public class ColumnsType {
  ...
  public ColumnsType column(@jakarta.annotation.Nonnull List<ColumnType> column) {
    this.column = column;
    return this;
  }

  public ColumnsType addColumnItem(ColumnType columnItem) {
    if (this.column == null) {
  ...
  @JsonProperty(JSON_PROPERTY_COLUMN)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setColumn(@jakarta.annotation.Nonnull List<ColumnType> column) {
    this.column = column;
  }
