 ...
 */
@JsonPropertyOrder({
  ScenarioCollectionResponse.JSON_PROPERTY_TOTAL_RESULTS,
  ScenarioCollectionResponse.JSON_PROPERTY_LIMIT,
  ScenarioCollectionResponse.JSON_PROPERTY_OFFSET,
  ScenarioCollectionResponse.JSON_PROPERTY_ITEMS,
  ScenarioCollectionResponse.JSON_PROPERTY_COUNT,
  ScenarioCollectionResponse.JSON_PROPERTY_HAS_MORE,
  ScenarioCollectionResponse.JSON_PROPERTY_PROPERTIES
})
...
public class ScenarioCollectionResponse {
  ...
  @jakarta.annotation.Nullable
  private List<ScenarioBean> items = new ArrayList<>();
  ...
  public ScenarioCollectionResponse() { 
  }

  public ScenarioCollectionResponse totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public ScenarioCollectionResponse limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ScenarioCollectionResponse offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  public ScenarioCollectionResponse items(@jakarta.annotation.Nullable List<ScenarioBean> items) {
    this.items = items;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<ScenarioBean> items) {
    this.items = items;
  }


  public ScenarioCollectionResponse count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public ScenarioCollectionResponse hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public ScenarioCollectionResponse properties(@jakarta.annotation.Nullable Map<String, String> properties) {
  ...
  /**
   * Return true if this ScenarioCollectionResponse object is equal to o.
   */
  @Override
