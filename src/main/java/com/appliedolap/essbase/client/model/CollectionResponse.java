 ...
 */
@JsonPropertyOrder({
  CollectionResponse.JSON_PROPERTY_COUNT,
  CollectionResponse.JSON_PROPERTY_ITEMS,
  CollectionResponse.JSON_PROPERTY_TOTAL_RESULTS,
  CollectionResponse.JSON_PROPERTY_HAS_MORE,
  CollectionResponse.JSON_PROPERTY_LIMIT,
  CollectionResponse.JSON_PROPERTY_PROPERTIES,
  CollectionResponse.JSON_PROPERTY_OFFSET
})
...
public class CollectionResponse {
  ...
  public CollectionResponse count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public CollectionResponse items(@jakarta.annotation.Nullable List<FileBean> items) {
    this.items = items;
    return this;
  }

  public CollectionResponse addItemsItem(FileBean itemsItem) {
    if (this.items == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<FileBean> items) {
    this.items = items;
  }


  public CollectionResponse totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public CollectionResponse hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public CollectionResponse limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public CollectionResponse properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public CollectionResponse putPropertiesItem(String key, String propertiesItem) {
  ...
  public CollectionResponse offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  /**
   * Return true if this CollectionResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, collectionResponse.count) &&
        Objects.equals(this.items, collectionResponse.items) &&
        Objects.equals(this.totalResults, collectionResponse.totalResults) &&
        Objects.equals(this.hasMore, collectionResponse.hasMore) &&
        Objects.equals(this.limit, collectionResponse.limit) &&
        Objects.equals(this.properties, collectionResponse.properties) &&
        Objects.equals(this.offset, collectionResponse.offset);
  }
