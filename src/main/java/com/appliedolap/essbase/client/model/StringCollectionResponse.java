 ...
 */
@JsonPropertyOrder({
  StringCollectionResponse.JSON_PROPERTY_TOTAL_RESULTS,
  StringCollectionResponse.JSON_PROPERTY_LIMIT,
  StringCollectionResponse.JSON_PROPERTY_OFFSET,
  StringCollectionResponse.JSON_PROPERTY_ITEMS,
  StringCollectionResponse.JSON_PROPERTY_COUNT,
  StringCollectionResponse.JSON_PROPERTY_HAS_MORE,
  StringCollectionResponse.JSON_PROPERTY_PROPERTIES
})
...
public class StringCollectionResponse {
  ...
  public StringCollectionResponse totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public StringCollectionResponse limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public StringCollectionResponse offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  public StringCollectionResponse items(@jakarta.annotation.Nullable List<String> items) {
    this.items = items;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<String> items) {
    this.items = items;
  }


  public StringCollectionResponse count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public StringCollectionResponse hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public StringCollectionResponse properties(@jakarta.annotation.Nullable Map<String, String> properties) {
  ...
  /**
   * Return true if this StringCollectionResponse object is equal to o.
   */
  @Override
