 ...
 */
@JsonPropertyOrder({
  ParticipantListResponse.JSON_PROPERTY_ITEMS,
  ParticipantListResponse.JSON_PROPERTY_COUNT,
  ParticipantListResponse.JSON_PROPERTY_TOTAL_RESULTS,
  ParticipantListResponse.JSON_PROPERTY_HAS_MORE,
  ParticipantListResponse.JSON_PROPERTY_LIMIT,
  ParticipantListResponse.JSON_PROPERTY_PROPERTIES,
...
public class ParticipantListResponse {
  ...
  private List<ParticipantBean> items = new ArrayList<>();
  ...
  public ParticipantListResponse items(@jakarta.annotation.Nullable List<ParticipantBean> items) {
    this.items = items;
    return this;
  }

  public ParticipantListResponse addItemsItem(ParticipantBean itemsItem) {
    if (this.items == null) {
  ...
  public List<ParticipantBean> getItems() {
    return items;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<ParticipantBean> items) {
    this.items = items;
  }


  public ParticipantListResponse count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public ParticipantListResponse totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public ParticipantListResponse hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public ParticipantListResponse limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ParticipantListResponse properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public ParticipantListResponse putPropertiesItem(String key, String propertiesItem) {
  ...
  public ParticipantListResponse offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  /**
   * Return true if this ParticipantListResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, participantListResponse.items) &&
        Objects.equals(this.count, participantListResponse.count) &&
        Objects.equals(this.totalResults, participantListResponse.totalResults) &&
        Objects.equals(this.hasMore, participantListResponse.hasMore) &&
        Objects.equals(this.limit, participantListResponse.limit) &&
        Objects.equals(this.properties, participantListResponse.properties) &&
