...
@JsonPropertyOrder({
  ...
  CompactDesignation.JSON_PROPERTY_EXCEL_ROW_COUNT
})
...
public class CompactDesignation {
  ...
  public enum DimDesignationModeEnum {
    ...
    DIM_DESIGNATION_MODE_OAV_SNOWFLAKE_DIM(String.valueOf("DIM_DESIGNATION_MODE_OAV_SNOWFLAKE_DIM")),
  ...
  public static final String JSON_PROPERTY_EXCEL_ROW_COUNT = "excelRowCount";
  @jakarta.annotation.Nullable
  private Integer excelRowCount;
  ...
  public CompactDesignation maxDate(@jakarta.annotation.Nullable OffsetDateTime maxDate) {
  ...
  @JsonProperty(JSON_PROPERTY_MAX_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMaxDate(@jakarta.annotation.Nullable OffsetDateTime maxDate) {
    this.maxDate = maxDate;
  }


  public CompactDesignation minDate(@jakarta.annotation.Nullable OffsetDateTime minDate) {
  ...
  @JsonProperty(JSON_PROPERTY_MIN_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMinDate(@jakarta.annotation.Nullable OffsetDateTime minDate) {
    this.minDate = minDate;
  }
  ...
  public CompactDesignation excelRowCount(@jakarta.annotation.Nullable Integer excelRowCount) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_EXCEL_ROW_COUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_EXCEL_ROW_COUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExcelRowCount(@jakarta.annotation.Nullable Integer excelRowCount) {
    this.excelRowCount = excelRowCount;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._file, compactDesignation._file) &&
        ...
        Objects.equals(this.excelRowCount, compactDesignation.excelRowCount);
  }
  ...
  public String toString() {
    ...
    sb.append("    excelRowCount: ").append(toIndentedString(excelRowCount)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `excelRowCount` to the URL query string
    if (getExcelRowCount() != null) {
      joiner.add(String.format("%sexcelRowCount%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getExcelRowCount()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
