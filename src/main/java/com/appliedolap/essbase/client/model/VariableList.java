 ...
 */
@JsonPropertyOrder({
  VariableList.JSON_PROPERTY_ITEMS,
  VariableList.JSON_PROPERTY_COUNT,
  VariableList.JSON_PROPERTY_TOTAL_RESULTS,
  VariableList.JSON_PROPERTY_HAS_MORE,
  VariableList.JSON_PROPERTY_LIMIT,
  VariableList.JSON_PROPERTY_PROPERTIES,
  VariableList.JSON_PROPERTY_OFFSET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class VariableList {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @jakarta.annotation.Nullable
  private List<Variable> items = new ArrayList<>();
  ...
  public VariableList items(@jakarta.annotation.Nullable List<Variable> items) {
    this.items = items;
    return this;
  }

  public VariableList addItemsItem(Variable itemsItem) {
    if (this.items == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<Variable> items) {
    this.items = items;
  }


  public VariableList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public VariableList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public VariableList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public VariableList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public VariableList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public VariableList putPropertiesItem(String key, String propertiesItem) {
  ...
  public VariableList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  /**
   * Return true if this VariableList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, variableList.items) &&
        Objects.equals(this.count, variableList.count) &&
        Objects.equals(this.totalResults, variableList.totalResults) &&
        Objects.equals(this.hasMore, variableList.hasMore) &&
        Objects.equals(this.limit, variableList.limit) &&
        Objects.equals(this.properties, variableList.properties) &&
        Objects.equals(this.offset, variableList.offset);
  }
