 ...
 */
@JsonPropertyOrder({
  CubeList.JSON_PROPERTY_ITEMS,
  CubeList.JSON_PROPERTY_COUNT,
  CubeList.JSON_PROPERTY_TOTAL_RESULTS,
  CubeList.JSON_PROPERTY_HAS_MORE,
  CubeList.JSON_PROPERTY_LIMIT,
  CubeList.JSON_PROPERTY_PROPERTIES,
  CubeList.JSON_PROPERTY_OFFSET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class CubeList {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @jakarta.annotation.Nullable
  private List<Cube> items = new ArrayList<>();
  ...
  public CubeList items(@jakarta.annotation.Nullable List<Cube> items) {
    this.items = items;
    return this;
  }

  public CubeList addItemsItem(Cube itemsItem) {
    if (this.items == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<Cube> items) {
    this.items = items;
  }


  public CubeList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public CubeList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public CubeList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public CubeList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public CubeList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public CubeList putPropertiesItem(String key, String propertiesItem) {
  ...
  public CubeList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  /**
   * Return true if this CubeList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, cubeList.items) &&
        Objects.equals(this.count, cubeList.count) &&
        Objects.equals(this.totalResults, cubeList.totalResults) &&
        Objects.equals(this.hasMore, cubeList.hasMore) &&
        Objects.equals(this.limit, cubeList.limit) &&
        Objects.equals(this.properties, cubeList.properties) &&
        Objects.equals(this.offset, cubeList.offset);
  }
