 ...
 */
@JsonPropertyOrder({
  FilterList.JSON_PROPERTY_ITEMS,
  FilterList.JSON_PROPERTY_COUNT,
  FilterList.JSON_PROPERTY_TOTAL_RESULTS,
  FilterList.JSON_PROPERTY_HAS_MORE,
  FilterList.JSON_PROPERTY_LIMIT,
  FilterList.JSON_PROPERTY_PROPERTIES,
  FilterList.JSON_PROPERTY_OFFSET
})
...
public class FilterList {
  ...
  public FilterList items(@jakarta.annotation.Nullable List<FilterBean> items) {
    this.items = items;
    return this;
  }

  public FilterList addItemsItem(FilterBean itemsItem) {
    if (this.items == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<FilterBean> items) {
    this.items = items;
  }


  public FilterList count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public FilterList totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public FilterList hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public FilterList limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public FilterList properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public FilterList putPropertiesItem(String key, String propertiesItem) {
  ...
  public FilterList offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  /**
   * Return true if this FilterList object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, filterList.items) &&
        Objects.equals(this.count, filterList.count) &&
        Objects.equals(this.totalResults, filterList.totalResults) &&
        Objects.equals(this.hasMore, filterList.hasMore) &&
        Objects.equals(this.limit, filterList.limit) &&
        Objects.equals(this.properties, filterList.properties) &&
        Objects.equals(this.offset, filterList.offset);
  }
