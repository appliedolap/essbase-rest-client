 ...
 */
@JsonPropertyOrder({
  Groups.JSON_PROPERTY_TOTAL_RESULTS,
  Groups.JSON_PROPERTY_COUNT,
  Groups.JSON_PROPERTY_LIMIT,
  Groups.JSON_PROPERTY_OFFSET,
  Groups.JSON_PROPERTY_ITEMS,
  Groups.JSON_PROPERTY_HAS_MORE,
  Groups.JSON_PROPERTY_PROPERTIES
})
...
public class Groups {
  ...
  public Groups totalResults(@jakarta.annotation.Nullable Long totalResults) {
  ...
  public Groups count(@jakarta.annotation.Nullable Long count) {
    this.count = count;
    return this;
  }
  ...
  public Groups limit(@jakarta.annotation.Nullable Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  public Groups offset(@jakarta.annotation.Nullable Long offset) {
    this.offset = offset;
    return this;
  }
  ...
  public Groups items(@jakarta.annotation.Nullable List<GroupBean> items) {
    this.items = items;
    return this;
  }

  public Groups addItemsItem(GroupBean itemsItem) {
    if (this.items == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable List<GroupBean> items) {
    this.items = items;
  }


  public Groups hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public Groups properties(@jakarta.annotation.Nullable Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public Groups putPropertiesItem(String key, String propertiesItem) {
  ...
  /**
   * Return true if this Groups object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalResults, groups.totalResults) &&
        Objects.equals(this.count, groups.count) &&
        Objects.equals(this.limit, groups.limit) &&
        Objects.equals(this.offset, groups.offset) &&
        Objects.equals(this.items, groups.items) &&
        Objects.equals(this.hasMore, groups.hasMore) &&
        Objects.equals(this.properties, groups.properties);
  }
