...
public class LocksApi {
   ...
   * @param applicationName &lt;p&gt;Application name.&lt;/p&gt; (required)
   * @param databaseName &lt;p&gt;Database name.&lt;/p&gt; (required)
   * @param lockObject &lt;p&gt;Details of object to be locked.&lt;/p&gt; (required)
   * @return LockObject
   * @throws ApiException if fails to make API call
   */
  public LockObject locksLockObject(String applicationName, String databaseName, LockObject lockObject) throws ApiException {
    ApiResponse<LockObject> localVarResponse = locksLockObjectWithHttpInfo(applicationName, databaseName, lockObject);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<LockObject> locksLockObjectWithHttpInfo(String applicationName, String databaseName, LockObject lockObject) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = locksLockObjectRequestBuilder(applicationName, databaseName, lockObject);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder locksLockObjectRequestBuilder(String applicationName, String databaseName, LockObject lockObject) throws ApiException {
    // verify the required parameter 'applicationName' is set
    if (applicationName == null) {
    ...
    // verify the required parameter 'lockObject' is set
    if (lockObject == null) {
      throw new ApiException(400, "Missing the required parameter 'lockObject' when calling locksLockObject");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(lockObject);
   ...
   * @param applicationName &lt;p&gt;Application name.&lt;/p&gt; (required)
   * @param databaseName &lt;p&gt;Database name.&lt;/p&gt; (required)
   * @param lockBlock &lt;p&gt;Block details to be unlocked.&lt;/p&gt; (required)
   * @throws ApiException if fails to make API call
   */
  public void locksUnLockBlock(String applicationName, String databaseName, LockBlock lockBlock) throws ApiException {
    locksUnLockBlockWithHttpInfo(applicationName, databaseName, lockBlock);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> locksUnLockBlockWithHttpInfo(String applicationName, String databaseName, LockBlock lockBlock) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = locksUnLockBlockRequestBuilder(applicationName, databaseName, lockBlock);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder locksUnLockBlockRequestBuilder(String applicationName, String databaseName, LockBlock lockBlock) throws ApiException {
    // verify the required parameter 'applicationName' is set
    if (applicationName == null) {
    ...
    // verify the required parameter 'lockBlock' is set
    if (lockBlock == null) {
      throw new ApiException(400, "Missing the required parameter 'lockBlock' when calling locksUnLockBlock");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(lockBlock);
      localVarRequestBuilder.method("POST", HttpRequest.BodyPublishers.ofByteArray(localVarPostBody));
    } catch (IOException e) {
      throw new ApiException(e);
    }
   ...
   * @param applicationName &lt;p&gt;Application name.&lt;/p&gt; (required)
   * @param databaseName &lt;p&gt;Database name.&lt;/p&gt; (required)
   * @param lockObject &lt;p&gt;Details about object to be unlocked.&lt;/p&gt; (required)
   * @throws ApiException if fails to make API call
   */
  public void locksUnLockObject(String applicationName, String databaseName, LockObject lockObject) throws ApiException {
    locksUnLockObjectWithHttpInfo(applicationName, databaseName, lockObject);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> locksUnLockObjectWithHttpInfo(String applicationName, String databaseName, LockObject lockObject) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = locksUnLockObjectRequestBuilder(applicationName, databaseName, lockObject);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder locksUnLockObjectRequestBuilder(String applicationName, String databaseName, LockObject lockObject) throws ApiException {
    // verify the required parameter 'applicationName' is set
    if (applicationName == null) {
    ...
    // verify the required parameter 'lockObject' is set
    if (lockObject == null) {
      throw new ApiException(400, "Missing the required parameter 'lockObject' when calling locksUnLockObject");
    }
