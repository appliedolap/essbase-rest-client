...
public class BatchOutlineEditingApi {
   ...
   * @param otlEditMain &lt;p&gt;Batch outline JSON/XML.&lt;/p&gt; (required)
   * @return BOEOutput
   * @throws ApiException if fails to make API call
   */
  public BOEOutput batchOutlineEditingExecute(String application, String database, OtlEditMain otlEditMain) throws ApiException {
    ApiResponse<BOEOutput> localVarResponse = batchOutlineEditingExecuteWithHttpInfo(application, database, otlEditMain);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<BOEOutput> batchOutlineEditingExecuteWithHttpInfo(String application, String database, OtlEditMain otlEditMain) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = batchOutlineEditingExecuteRequestBuilder(application, database, otlEditMain);
    try {
  ...
  private HttpRequest.Builder batchOutlineEditingExecuteRequestBuilder(String application, String database, OtlEditMain otlEditMain) throws ApiException {
    ...
    // verify the required parameter 'otlEditMain' is set
    if (otlEditMain == null) {
      throw new ApiException(400, "Missing the required parameter 'otlEditMain' when calling batchOutlineEditingExecute");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(otlEditMain);
