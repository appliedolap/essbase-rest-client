...
public class ApplicationConfigurationApi {
   ...
   * @param applicationConfigEntry &lt;p&gt;Configuration property entry.&lt;/p&gt; (required)
   * @return ApplicationConfigEntry
   * @throws ApiException if fails to make API call
   */
  public ApplicationConfigEntry applicationConfigurationAddConfiguration(String applicationName, ApplicationConfigEntry applicationConfigEntry) throws ApiException {
    ApiResponse<ApplicationConfigEntry> localVarResponse = applicationConfigurationAddConfigurationWithHttpInfo(applicationName, applicationConfigEntry);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ApplicationConfigEntry> applicationConfigurationAddConfigurationWithHttpInfo(String applicationName, ApplicationConfigEntry applicationConfigEntry) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = applicationConfigurationAddConfigurationRequestBuilder(applicationName, applicationConfigEntry);
    try {
  ...
  private HttpRequest.Builder applicationConfigurationAddConfigurationRequestBuilder(String applicationName, ApplicationConfigEntry applicationConfigEntry) throws ApiException {
    ...
    // verify the required parameter 'applicationConfigEntry' is set
    if (applicationConfigEntry == null) {
      throw new ApiException(400, "Missing the required parameter 'applicationConfigEntry' when calling applicationConfigurationAddConfiguration");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(applicationConfigEntry);
   ...
   * @param applicationName &lt;p&gt;Application name.&lt;/p&gt; (required)
   * @param orderBy Order By specification in format:&lt;code&gt;column&lt;/code&gt;:&lt;code&gt;direction&lt;/code&gt;. e.g.&lt;code&gt;key:asc&lt;/code&gt; &lt;/p&gt; (optional, default to )
   * @return ApplicationConfigList
   * @throws ApiException if fails to make API call
   */
  public ApplicationConfigList applicationConfigurationGetConfigurations(String applicationName, String orderBy) throws ApiException {
    ApiResponse<ApplicationConfigList> localVarResponse = applicationConfigurationGetConfigurationsWithHttpInfo(applicationName, orderBy);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ApplicationConfigList> applicationConfigurationGetConfigurationsWithHttpInfo(String applicationName, String orderBy) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = applicationConfigurationGetConfigurationsRequestBuilder(applicationName, orderBy);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder applicationConfigurationGetConfigurationsRequestBuilder(String applicationName, String orderBy) throws ApiException {
    // verify the required parameter 'applicationName' is set
    if (applicationName == null) {
   ...
   * @param applicationName &lt;p&gt;Application name.&lt;/p&gt; (required)
   * @param configId &lt;p&gt;Configuration property name.&lt;/p&gt; (required)
   * @param applicationConfigEntry &lt;p&gt;Configuration property value entry.&lt;/p&gt; (required)
   * @return ApplicationConfigEntry
   * @throws ApiException if fails to make API call
   */
  public ApplicationConfigEntry applicationConfigurationSetConfiguration(String applicationName, String configId, ApplicationConfigEntry applicationConfigEntry) throws ApiException {
    ApiResponse<ApplicationConfigEntry> localVarResponse = applicationConfigurationSetConfigurationWithHttpInfo(applicationName, configId, applicationConfigEntry);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ApplicationConfigEntry> applicationConfigurationSetConfigurationWithHttpInfo(String applicationName, String configId, ApplicationConfigEntry applicationConfigEntry) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = applicationConfigurationSetConfigurationRequestBuilder(applicationName, configId, applicationConfigEntry);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder applicationConfigurationSetConfigurationRequestBuilder(String applicationName, String configId, ApplicationConfigEntry applicationConfigEntry) throws ApiException {
    // verify the required parameter 'applicationName' is set
    if (applicationName == null) {
    ...
    // verify the required parameter 'applicationConfigEntry' is set
    if (applicationConfigEntry == null) {
      throw new ApiException(400, "Missing the required parameter 'applicationConfigEntry' when calling applicationConfigurationSetConfiguration");
    }
   ...
   * @param applicationName &lt;p&gt;Application name.&lt;/p&gt; (required)
   * @param applicationConfigEntry &lt;p&gt;Configuration property value entries.&lt;/p&gt; (required)
   * @return ApplicationConfigList
   * @throws ApiException if fails to make API call
   */
  public ApplicationConfigList applicationConfigurationSetConfigurations(String applicationName, List<ApplicationConfigEntry> applicationConfigEntry) throws ApiException {
    ApiResponse<ApplicationConfigList> localVarResponse = applicationConfigurationSetConfigurationsWithHttpInfo(applicationName, applicationConfigEntry);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ApplicationConfigList> applicationConfigurationSetConfigurationsWithHttpInfo(String applicationName, List<ApplicationConfigEntry> applicationConfigEntry) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = applicationConfigurationSetConfigurationsRequestBuilder(applicationName, applicationConfigEntry);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder applicationConfigurationSetConfigurationsRequestBuilder(String applicationName, List<ApplicationConfigEntry> applicationConfigEntry) throws ApiException {
    // verify the required parameter 'applicationName' is set
    if (applicationName == null) {
    ...
    // verify the required parameter 'applicationConfigEntry' is set
    if (applicationConfigEntry == null) {
      throw new ApiException(400, "Missing the required parameter 'applicationConfigEntry' when calling applicationConfigurationSetConfigurations");
    }
