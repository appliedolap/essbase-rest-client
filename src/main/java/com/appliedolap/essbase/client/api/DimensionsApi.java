...
public class DimensionsApi {
   ...
   * @param generationLevel &lt;p&gt;Generation details.&lt;/p&gt; (required)
   * @return GenerationLevel
   * @throws ApiException if fails to make API call
   */
  public GenerationLevel dimensionsEditDimGenerations(String applicationName, String databaseName, String dimensionName, Integer generationNumber, GenerationLevel generationLevel) throws ApiException {
    ApiResponse<GenerationLevel> localVarResponse = dimensionsEditDimGenerationsWithHttpInfo(applicationName, databaseName, dimensionName, generationNumber, generationLevel);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<GenerationLevel> dimensionsEditDimGenerationsWithHttpInfo(String applicationName, String databaseName, String dimensionName, Integer generationNumber, GenerationLevel generationLevel) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = dimensionsEditDimGenerationsRequestBuilder(applicationName, databaseName, dimensionName, generationNumber, generationLevel);
    try {
  ...
  private HttpRequest.Builder dimensionsEditDimGenerationsRequestBuilder(String applicationName, String databaseName, String dimensionName, Integer generationNumber, GenerationLevel generationLevel) throws ApiException {
    ...
    // verify the required parameter 'generationLevel' is set
    if (generationLevel == null) {
      throw new ApiException(400, "Missing the required parameter 'generationLevel' when calling dimensionsEditDimGenerations");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(generationLevel);
   ...
   * @param generationLevel &lt;p&gt;Level details.&lt;/p&gt; (required)
   * @return GenerationLevel
   * @throws ApiException if fails to make API call
   */
  public GenerationLevel dimensionsEditDimLevels(String applicationName, String databaseName, String dimensionName, Integer levelNumber, GenerationLevel generationLevel) throws ApiException {
    ApiResponse<GenerationLevel> localVarResponse = dimensionsEditDimLevelsWithHttpInfo(applicationName, databaseName, dimensionName, levelNumber, generationLevel);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<GenerationLevel> dimensionsEditDimLevelsWithHttpInfo(String applicationName, String databaseName, String dimensionName, Integer levelNumber, GenerationLevel generationLevel) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = dimensionsEditDimLevelsRequestBuilder(applicationName, databaseName, dimensionName, levelNumber, generationLevel);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder dimensionsEditDimLevelsRequestBuilder(String applicationName, String databaseName, String dimensionName, Integer levelNumber, GenerationLevel generationLevel) throws ApiException {
    // verify the required parameter 'applicationName' is set
    if (applicationName == null) {
    ...
    // verify the required parameter 'generationLevel' is set
    if (generationLevel == null) {
      throw new ApiException(400, "Missing the required parameter 'generationLevel' when calling dimensionsEditDimLevels");
    }
