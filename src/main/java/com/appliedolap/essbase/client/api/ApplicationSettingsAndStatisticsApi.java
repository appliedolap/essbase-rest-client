...
public class ApplicationSettingsAndStatisticsApi {
   ...
   * @param applicationName &lt;p&gt;Application name.&lt;/p&gt; (required)
   * @param patchElement &lt;p&gt;Application settings patch list.&lt;/p&gt; (required)
   * @throws ApiException if fails to make API call
   */
  public void applicationSettingsStatisticsUpdateSettings(String applicationName, List<PatchElement> patchElement) throws ApiException {
    applicationSettingsStatisticsUpdateSettingsWithHttpInfo(applicationName, patchElement);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> applicationSettingsStatisticsUpdateSettingsWithHttpInfo(String applicationName, List<PatchElement> patchElement) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = applicationSettingsStatisticsUpdateSettingsRequestBuilder(applicationName, patchElement);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder applicationSettingsStatisticsUpdateSettingsRequestBuilder(String applicationName, List<PatchElement> patchElement) throws ApiException {
    // verify the required parameter 'applicationName' is set
    if (applicationName == null) {
    ...
    if (patchElement == null) {
      throw new ApiException(400, "Missing the required parameter 'patchElement' when calling applicationSettingsStatisticsUpdateSettings");
    }
