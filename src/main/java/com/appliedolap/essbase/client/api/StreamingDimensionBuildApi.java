...
public class StreamingDimensionBuildApi {
   ...
   * @param databaseName &lt;p&gt;Database name.&lt;/p&gt; (required)
   * @param streamId &lt;p&gt;Stream ID.&lt;/p&gt; (required)
   * @param ruleFileName &lt;p&gt;Rules file name.&lt;/p&gt; (required)
   * @return StreamProcessEndResponse
   * @throws ApiException if fails to make API call
   */
   ...
   * @param applicationName &lt;p&gt;Application name.&lt;/p&gt; (required)
   * @param databaseName &lt;p&gt;Database name.&lt;/p&gt; (required)
   * @param dimBuildStartPayload &lt;p&gt;Dimension build attributes, such as the restructure option. If empty, the default value for restructure option is  &lt;code&gt;PRESERVE_ALL_DATA&lt;/code&gt;. (optional)
   * @return StreamProcessStartResponse
   * @throws ApiException if fails to make API call
   */
  public StreamProcessStartResponse dimensionBuildStart(String applicationName, String databaseName, DimBuildStartPayload dimBuildStartPayload) throws ApiException {
    ApiResponse<StreamProcessStartResponse> localVarResponse = dimensionBuildStartWithHttpInfo(applicationName, databaseName, dimBuildStartPayload);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<StreamProcessStartResponse> dimensionBuildStartWithHttpInfo(String applicationName, String databaseName, DimBuildStartPayload dimBuildStartPayload) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = dimensionBuildStartRequestBuilder(applicationName, databaseName, dimBuildStartPayload);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder dimensionBuildStartRequestBuilder(String applicationName, String databaseName, DimBuildStartPayload dimBuildStartPayload) throws ApiException {
    // verify the required parameter 'applicationName' is set
    if (applicationName == null) {
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(dimBuildStartPayload);
   ...
   * @param databaseName &lt;p&gt;Database name.&lt;/p&gt; (required)
   * @param streamId &lt;p&gt;Stream ID.&lt;/p&gt; (required)
   * @param ruleFileName &lt;p&gt;Rule File Name.&lt;/p&gt; (required)
   * @return StreamProcessStartResponse
   * @throws ApiException if fails to make API call
   */
