...
public class StreamingDataLoadApi {
   ...
   * @param applicationName &lt;p&gt;Application name.&lt;/p&gt; (required)
   * @param databaseName &lt;p&gt;Database name.&lt;/p&gt; (required)
   * @param dataLoadStartPayload &lt;p&gt;Data load options such as rule file name and delimiter.&lt;/p&gt; (optional)
   * @return StreamProcessStartResponse
   * @throws ApiException if fails to make API call
   */
  public StreamProcessStartResponse dataloadStart(String applicationName, String databaseName, DataLoadStartPayload dataLoadStartPayload) throws ApiException {
    ApiResponse<StreamProcessStartResponse> localVarResponse = dataloadStartWithHttpInfo(applicationName, databaseName, dataLoadStartPayload);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<StreamProcessStartResponse> dataloadStartWithHttpInfo(String applicationName, String databaseName, DataLoadStartPayload dataLoadStartPayload) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = dataloadStartRequestBuilder(applicationName, databaseName, dataLoadStartPayload);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder dataloadStartRequestBuilder(String applicationName, String databaseName, DataLoadStartPayload dataLoadStartPayload) throws ApiException {
    // verify the required parameter 'applicationName' is set
    if (applicationName == null) {
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(dataLoadStartPayload);
   ...
   * @param applicationName &lt;p&gt;Application name.&lt;/p&gt; (required)
   * @param databaseName &lt;p&gt;Database name.&lt;/p&gt; (required)
   * @param streamId &lt;p&gt;Stream ID returned from the Start Data Load operation.&lt;/p&gt; (required)
   * @param body &lt;p&gt;Comma-separated data.&lt;/p&gt; (optional)
   * @return StreamProcessStartResponse
   * @throws ApiException if fails to make API call
   */
